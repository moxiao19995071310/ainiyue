...
//        FileInputStream instream = new FileInputStream(new File("D:/workspace3/loveyou/WebContent/apiclient_cert.p12"));
//        try {
//        	//keyStore.load(instream, "10016225".toCharArray());
//            keyStore.load(instream, "1348107201".toCharArray());
//        } finally {
//            instream.close();
//        }
//
...
//                .loadKeyMaterial(keyStore, "1348107201".toCharArray())
//                .build();
